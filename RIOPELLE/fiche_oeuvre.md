...
<h2 align=center>Cartel</h2>
 <h1 align=center><img src='./medias/RIOPELLE_cartel_20240301.jpg' width=40% height=40%></h1>
 
<h3 align=center>Mise en espace</h3>

À l'entrée, les visiteurs sont accueillis par un bureau de réception situé sur la gauche, où un code QR est disponible, fournissant diverses informations sur l'exposition, y compris les détails des œuvres exposées. Cette zone s'intègre harmonieusement avec l'exposition principale, où sont présentées les toiles, sculptures et interactions artistiques. De là, un escalier mène également au sous-sol, qui abrite la section consacrée aux Inuits ainsi qu'une salle de présentation vidéo sur la vie de Riopelle. Dans cette salle, six grands écrans sont disposés sur chaque mur rectangulaire, diffusant le son à travers des haut-parleurs positionnés au plafond. L'absence apparente de fils électriques crée une atmosphère aérée et spacieuse. Au centre de la salle se trouve un podium orné d'oiseaux en papier et de branches, évoquant un nid. Pour compléter l'ambiance, des brins d'herbe artificiels bordent la salle sous les écrans.
<br>
<br>
